        ...
        <div className="advantages-wrapper">
            <div className="advantages">
                <div className="left">
                    <p id="title">
                        Why <br />
                        <span>You Get </span>With <br />
                        Our Furniture
                    </p>
                    <p id="desc">
                        More by more profit for you buy the best , Do your <br />
                        home start, good, loking mordern
                    </p>
                </div>
                <div className="right">
                    <div className="card">
                    ...
                    <div className="card">
                        ...
                        <p id='title'>Support 24/7</p>
                    </div>
                    <div className="card">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-shield-check" viewBox="0 0 16 16">
